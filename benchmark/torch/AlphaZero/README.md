...
In this example, we provide an AlphaZero baseline to solve the Connect4 game, which is based on the code of [suragnair/alpha-zero-general](https://github.com/suragnair/alpha-zero-general) repo.
