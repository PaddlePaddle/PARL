...
atari_config = {
    ...
    'num_minibatches': 4,
    'update_epochs': 4,     # number of epochs for updating using each T data (ie K in the paper)
    ...
    #========== coefficient of ppo ==========
    'clip_coef': 0.1,       # epsilon in clipping loss (ie. clip(r_t, 1 - epsilon, 1 + epsilon))
