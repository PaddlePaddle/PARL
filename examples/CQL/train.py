...
def main():
    ...
    for total_steps in trange(int(args.train_total_steps)):
        ...
        batch_obs, batch_action, batch_reward, batch_next_obs, batch_terminal = rpm.sample_batch(
            BATCH_SIZE)
        closs, aloss = agent.learn(batch_obs, batch_action, batch_reward, batch_next_obs,
                    batch_terminal)
        tensorboard.add_scalar('train/critic_loss', closs.cpu().numpy(),
                               total_steps)
        tensorboard.add_scalar('train/actor_loss', aloss.cpu().numpy(),
                               total_steps)
