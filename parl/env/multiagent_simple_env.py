...
try:
    ...
    logger.warning('Can not use MAenv from parl.env.multiagent_simple_env, \
        pip install multiagent according to https://github.com/openai/multiagent-particle-envs \
