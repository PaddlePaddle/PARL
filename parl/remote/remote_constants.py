...
CLIENT_STATUS_UPDATE_TAG = b'[CLIENT_STATUS_UPDATE_TAG]'
...
NORMAL_TAG = b'[NORMAL]'
REJECT_GPU_JOB_TAG = b'[REJECT_GPU_JOB]'
REJECT_CPU_JOB_TAG = b'[REJECT_CPU_JOB]'
REJECT_GPU_WORKER_TAG = b'[REJECT_GPU_WORKER]'
REJECT_CPU_WORKER_TAG = b'[REJECT_CPU_WORKER]'
REJECT_INVALID_GPU_JOB_TAG = b'[REJECT_INVALID_GPU_JOB]'
...
HEARTBEAT_OUT_OF_MEMORY_TAG = b'[HEARTBEAT_OUT_OF_MEMORY]'
