...
```bash
Run successfully with command - python3.7 train.py --output-dir=./log/DQN/lite_train_lite_infer/norm_train_gpus_0 --epochs=5   --batch-size=4!
......
Run successfully with command - python3.7 deploy/inference_python/infer.py --use-gpu=False --model-dir=./log/DQN/lite_train_lite_infer/norm_train_gpus_0,1 --batch-size=1   --benchmark=True > ./log/DQN/lite_train_lite_infer/python_infer_cpu_batchsize_1.log 2>&1 !
```
